...
class TicketView(discord.ui.View):
    ...
    async def create_ticket(
        ...
        overwrites = {
            ...
            # Everyone else cannot see ticket
            guild.default_role:
...
async def setup_ticket_panels(
    ...
    for channel_name in TICKET_PANEL_CHANNELS:
        ...
        exists = await ticket_panel_exists(
            channel
        )
        ...
        embed = discord.Embed(
            ...
            description=(
                ...
                "Only you and Staff will be able "
                "to see your ticket."
            ),
            color=discord.Color.blurple()
        )
...
async def setup_tickets_command(
    ctx
):
